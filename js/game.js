                ...
                Player.getPlayerInfo();
                 ...
                 for(var plr in allPlayers){
                     ...
                     if(index === player.index){
                       ...
                       textSize(25);
                       fill("black");
                       text(allPlayers.player1.name,(-(allPlayers.player1.distance))+460,y+25);
                       text(allPlayers.player2.name,(-(allPlayers.player2.distance))+460,y+25);
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if (frameCount % 20 === 0) {
                     ...
                     switch(rand){
                         ...
                         break;
                         case 5: fruits.addImage("fruit1", fruit5_imgm);
                         break;
                     }
